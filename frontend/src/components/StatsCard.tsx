...
export function StatsCard({ 
  ...
  return (
    <div className="bg-[var(--bg-surface-elevated)] border border-[var(--border)] rounded-2xl p-5 flex flex-col gap-4 shadow-sm hover:shadow-md hover:border-[var(--accent-primary)]/50 transition-all duration-300 group">
      ...
      <div>
        <p className="text-xl font-extrabold text-[var(--text-primary)] tracking-tight">{value}</p>
